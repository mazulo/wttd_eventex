...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        expect = ''
        self.assertIn('Patrick Mazulo', email.body)
        self.assertIn('03286218383', email.body)
        self.assertIn('pmazulo@gmail.com', email.body)
        self.assertIn('86-99988-7848', email.body)
